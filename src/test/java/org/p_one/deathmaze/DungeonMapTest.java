...
public class DungeonMapTest extends TestCase {
	...
	public void testAddRoomMustHaveUniqueCoords() {
		DungeonMap map = new DungeonMap();
		Room room = new Room(0, 0, Room.Exit.DOOR, Room.Exit.NONE, Room.Exit.NONE, Room.Exit.NONE);
		Room room2 = new Room(0, 0, Room.Exit.DOOR, Room.Exit.NONE, Room.Exit.NONE, Room.Exit.NONE);
		map.add(room);
		map.add(room2);
	...
	public void testAddedRoomsMustBeAdjacent() {
		DungeonMap map = new DungeonMap();
		Room room = new Room(0, 0, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR);
		map.add(room);

		Room adjacent_room = new Room(0, 1, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR);
		Room not_adj_room = new Room(0, 6, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR);
	...
	public void testValidRoomMustConnect() {
		DungeonMap map = new DungeonMap();
		Room room = new Room(0, 0, Room.Exit.DOOR, Room.Exit.NONE, Room.Exit.DOOR, Room.Exit.NONE);
		map.add(room);

		Room connects_room = new Room(0, 1, Room.Exit.DOOR, Room.Exit.NONE, Room.Exit.NONE, Room.Exit.NONE);
		Room breaks_connection_room = new Room(-1, 0, Room.Exit.NONE, Room.Exit.DOOR, Room.Exit.NONE, Room.Exit.NONE);
		Room not_connected_room = new Room(1, 0, Room.Exit.DOOR, Room.Exit.NONE, Room.Exit.DOOR, Room.Exit.NONE);
		Room distant_room = new Room(5, 5, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR);
	...
	public void testGetRoom() {
		DungeonMap map = new DungeonMap();
		Room base_room = new Room(1, 0, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR);
		map.add(base_room);
		Room room = new Room(0, 0, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR, Room.Exit.DOOR);
		map.add(room);
